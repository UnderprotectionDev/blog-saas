  ...
  return (
    <>
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center leading-tight text-muted-foreground">
        We offer a variety of pricing plans to suit your needs. Choose the plan
        that works best for you and get started today. Our plans are designed to
        scale with your business and provide the features you need to succeed.
      </p>
